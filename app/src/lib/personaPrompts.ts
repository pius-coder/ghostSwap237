...
export const PERSONA_PRESERVATION_LINE =
  "Replace the character in the video with the character in the reference image. Completely replace the main person with the reference character — adopt the reference person's body shape, weight, corpulence, height, and facial structure/proportions exactly, do not retain the input person's body shape, weight or face thinness; preserve only the original person's facial expression, gaze direction, natural eye contact, pose, motion, and gestures with no eye bulging or distortion and eyes proportionate; keep the background static with consistent lighting, no light overlays, no flicker, and camera movement unchanged.";
...
export const PRO_QUALITY_SUFFIX =
  ' Keep the same person from the reference image (same face and identity, face swap, same body shape, weight and corpulence as reference, do not thin or fatten the face/body), with natural movements and expressions, natural eye contact without bulging, high detail, sharp focus, stable background and consistent lighting without overlays.';
