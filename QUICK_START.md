...
4. Synchronisez la version: `cd app; bun run release:sync 2.0.26`.
...
8. Commitez la version, creez le tag `v2.0.26`, puis poussez le commit et le tag.
9. Verifiez la release: `Henshin-Setup-2.0.26.exe`, son fichier `.sha256`, puis `/api/version`.
10. Validez installation, camera et desinstallation sur une VM Windows 11 x64 build 22000+ propre, sans Visual Studio ni redistribuable VC++.
