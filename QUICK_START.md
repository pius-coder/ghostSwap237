...
4. Synchronisez la version: `cd app; bun run release:sync 2.0.25`.
...
8. Commitez la version, creez le tag `v2.0.25`, puis poussez le commit et le tag.
9. Verifiez la release: `Henshin-Setup-2.0.25.exe`, son fichier `.sha256`, puis `/api/version`.
